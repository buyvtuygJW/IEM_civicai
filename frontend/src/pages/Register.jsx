...
const DEPARTMENTS = [
  "Electricity Department", "Water Board", "Sanitation Department",
  "Municipal Sanitation Department", "Public Works Department (PWD)",
  "Town Planning Department", "Animal Control Department",
  "Pollution Control Board", "Traffic Police Department",
  "Welfare & Social Justice Department", "General Municipal Office",
];
