...
accuracy on messy/ambiguous text — which matters a lot here, since the keyword
lists below cover only the most common word for each issue in each language
and won't catch every phrasing.
"""
